...
public class EmployeeMain {
    public static void main(String[] args) {
        // we can use variables of different classes by using the object in main method
        //main method can be specified only in one class
        //that class becomes main class and rest all are plain class
